...
public class ItemManager {
	...
	public static ItemStack Super_Mushroom;
	...
	private static void createItems() {
		...
		ItemStack SuperMushroom = new ItemStack(Material.APPLE, 1);
		ItemMeta SuperMushroomMeta = SuperMushroom.getItemMeta();
		...
		SuperMushroomMeta.setDisplayName(ChatColor.RED + "Super Mushroom" + ChatColor.BOLD);
		SuperMushroomMeta.setItemModel(new NamespacedKey("ec", "supermushroom"));
		SuperMushroomMeta.setLore(Arrays.asList("One Super Mushroom a day, ", "keeps the doctor a way!"));

		RefinedCrimsonExtractMeta.setDisplayName(ChatColor.RED + "Refined Crimson Extract");
		RefinedCrimsonExtractMeta.setItemModel(new NamespacedKey("ec", "refinedcrimsonextract"));

		CrimsonExtractMeta.setDisplayName(ChatColor.DARK_RED + "Crimson Extract");
		CrimsonExtractMeta.setItemModel(new NamespacedKey("ec", "crimsonextract"));

		BeamBoxMeta.setDisplayName(ChatColor.RED + "Beam Box" + ChatColor.BOLD);
		BeamBoxMeta.setItemModel(new NamespacedKey("ec", "beambox"));
		...
		FireFlowerMeta.setLore(Arrays.asList(
		...
		FireFlowerMeta.setItemModel(new NamespacedKey("ec", "fireflower"));
		...
		IceFlowerMeta.setLore(Arrays.asList(
				"This cold flower launches",
				"freezing snowballs that",
				"will slow and trap enemies in ice."
		));
		IceFlowerMeta.setItemModel(new NamespacedKey("ec", "iceflower"));
		...
		RockMushroomMeta.setLore(Arrays.asList(
				"This mushroom, despite being ",
		...
		RockMushroomMeta.setItemModel(new NamespacedKey("ec", "rockmushroom"));

		CloudFlowerMeta.setDisplayName(ChatColor.WHITE + "Cloud Flower" + ChatColor.BOLD);
		CloudFlowerMeta.setLore(Arrays.asList(
				"This flower has a tendency ",
		...
		CloudFlowerMeta.setItemModel(new NamespacedKey("ec", "cloudflower"));
		...
		RainbowStarMeta.setLore(Arrays.asList(
				"Immense and colorful energy is",
		...
		RainbowStarMeta.setItemModel(new NamespacedKey("ec", "rainbowstar"));
		RainbowStarMeta.addEnchant(Enchantment.INFINITY, 1, true);
		RainbowStarMeta.addItemFlags(ItemFlag.HIDE_ENCHANTS);
		((Damageable) RainbowStarMeta).setMaxDamage(1);

		OneUpMushroomMeta.setDisplayName(ChatColor.GREEN + "1-Up Mushroom" + ChatColor.BOLD);
		OneUpMushroomMeta.setLore(Arrays.asList(
				"A 1Up mushroom a day, ",
				"keeps the death away!"
		));
		OneUpMushroomMeta.setItemModel(new NamespacedKey("ec", "oneupmushroom"));

		RedStarMeta.setDisplayName(ChatColor.RED + "★ Red Star ★" + ChatColor.BOLD);
		RedStarMeta.setLore(Arrays.asList(
				"This unique star contains a strange",
				"power, and channeling it will",
				"provide you with the ability",
				"freely fly for a long period of time"
		));
		RedStarMeta.setItemModel(new NamespacedKey("ec", "redstar"));
		RedStarMeta.addEnchant(Enchantment.INFINITY, 1, true);
		RedStarMeta.addItemFlags(ItemFlag.HIDE_ENCHANTS);
		((Damageable) RedStarMeta).setMaxDamage(1);


		SuperMushroom.setItemMeta(SuperMushroomMeta);
