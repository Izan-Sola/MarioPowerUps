package me.ShinyShadow_.MarioPowerUps.PowerUps.Mushrooms.RockMushroom;
...
public class RockMushroomSphere {
    ...
    public static BossBar powerUpBar;
    ...
    public RockMushroomSphere(Player player, JavaPlugin plugin, ProtocolManager protocolManager) {
        this.player = player;
        powerUpBar = Bukkit.createBossBar("RockMushroom Duration", BarColor.WHITE, BarStyle.SOLID);
        ...
        task1 = new BukkitRunnable() {
            ...
            public void run() {
                ...
                duration -= 0.05;
                if(duration <= 0 || !player.isOnline() || player.isDead()) {
